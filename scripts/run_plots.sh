...
# for exp in gaussian_full # gaussian multimodal xshaped
#     do
...
#         taskset -c 11-16 python plots/plot_seeds.py --exp=$exp --nparticles=500 --epochs=2000 --lr=0.1 --delta=0.1 --root=res_1010_final --metric=var
#     done
